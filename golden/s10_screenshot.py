...
def variant_a(prs):
    ...
    pic = slide.shapes.add_picture(IMG_3D, Inches(G.MARGIN_L), Inches(1.8), height=Inches(img_h))
    ...
    add_text(
        ...
        img_w - 0.65,
        0.3,
        "실제 운영 화면 — 지식그래프 3D 뷰어 (초기 V1 스냅샷, 수치 표기는 그래프 v14 기준)",
        S["caption"],
        F["body"],
        C["muted"],
    )
