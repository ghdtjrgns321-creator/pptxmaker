...
def variant_k(prs, c=None):
    """2칸 — 좌: 오류 두 방향(1종/2종 비교), 우: 같은 질문 두 결말. c: 텍스트 override(좌표·색 고정)."""
    c = {**DEFAULT, **(c or {})}
    ...
    # ── 우칸: 같은 질문, 두 개의 결말 (질문 카드 + 2 결말 카드) ──
