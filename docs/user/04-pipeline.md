...
NotebookLM 보고서(보조)      │   보고서형 8요소로 직접 추출 + 수치·고유명사 검증
                             ...
                             ▼
                          ①.5 목차 공동설계 게이트 (deck-outline-grill)
                          ...
                          ③ pptx-builder
                             ...
                             │   type "golden.*" → goldenfab registry(15타입) / 그 외 → 레거시 렌더러
...
| ①.5  | 목차 공동설계 게이트 | deck-outline-grill | 01_extracted.md                   | 01.5_outline.md (아웃라인 계약) |
...
- ①·② (콘텐츠 트랙)는 유지하되, 내용 고도 상향(임원 언어 큐레이션)이 ②에 추가될 예정이다.
